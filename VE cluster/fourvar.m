...
for i=0:n-1
    if i==0 %first drop (pbc)
        dy(1+i*4) = -k1*y(1+i*4)*y(2+i*4)+k2*y(2+i*4)-2*k3*y(1+i*4)^2+k4*y(1+i*4)*(c0-y(3+i*4))/(c0-y(3+i*4)+cmin) + dc(1)*(y(1+(i+1)*4)+y(1+(n-1)*4)-2*y(1+i*4));
        dy(2+i*4) = -3*k1*y(1+i*4)*y(2+i*4)-2*k2*y(2+i*4)-k3*y(1+i*4)^2+k7*y(4+i*4)+k9*y(3+i*4)+ dc(2)*(y(2+(i+1)*4)+y(2+(n-1)*4)-2*y(2+i*4));
        dy(3+i*4) = 2*k4*y(1+i*4)*(c0-y(3+i*4))/(c0-y(3+i*4)+cmin)-k9*y(3+i*4)-k10*y(3+i*4)+ dc(3)*(y(3+(i+1)*4)+y(3+(n-1)*4)-2*y(3+i*4));%-0.001*y(3+i*4);%ferroin decay?
        dy(4+i*4) = 2*k1*y(1+i*4)*y(2+i*4)+k2*y(2+i*4)+k3*y(1+i*4)^2-k7*y(4+i*4)+ dc(4)*(y(4+(i+1)*4)+y(4+(n-1)*4)-2*y(4+i*4));
        
    elseif i==n-1 %last drop (pbc)
        dy(1+i*4) = -k1*y(1+i*4)*y(2+i*4)+k2*y(2+i*4)-2*k3*y(1+i*4)^2+k4*y(1+i*4)*(c0-y(3+i*4))/(c0-y(3+i*4)+cmin)+ dc(1)*(y(1+0*4)+y(1+(i-1)*4)-2*y(1+i*4));
        dy(2+i*4) = -3*k1*y(1+i*4)*y(2+i*4)-2*k2*y(2+i*4)-k3*y(1+i*4)^2+k7*y(4+i*4)+k9*y(3+i*4)+ dc(2)*(y(2+0*4)+y(2+(i-1)*4)-2*y(2+i*4));
        dy(3+i*4) = 2*k4*y(1+i*4)*(c0-y(3+i*4))/(c0-y(3+i*4)+cmin)-k9*y(3+i*4)-k10*y(3+i*4)+ dc(3)*(y(3+0*4)+y(3+(i-1)*4)-2*y(3+i*4));%-0.001*y(3+i*4);%ferroin decay?
        dy(4+i*4) = 2*k1*y(1+i*4)*y(2+i*4)+k2*y(2+i*4)+k3*y(1+i*4)^2-k7*y(4+i*4)+ dc(4)*(y(4+0*4)+y(4+(i-1)*4)-2*y(4+i*4));
        
    else %drops in between
        dy(1+i*4) = -k1*y(1+i*4)*y(2+i*4)+k2*y(2+i*4)-2*k3*y(1+i*4)^2+k4*y(1+i*4)*(c0-y(3+i*4))/(c0-y(3+i*4)+cmin) + dc(1)*(y(1+(i+1)*4)+y(1+(i-1)*4)-2*y(1+i*4));
        dy(2+i*4) = -3*k1*y(1+i*4)*y(2+i*4)-2*k2*y(2+i*4)-k3*y(1+i*4)^2+k7*y(4+i*4)+k9*y(3+i*4)+ dc(2)*(y(2+(i+1)*4)+y(2+(i-1)*4)-2*y(2+i*4));
        dy(3+i*4) = 2*k4*y(1+i*4)*(c0-y(3+i*4))/(c0-y(3+i*4)+cmin)-k9*y(3+i*4)-k10*y(3+i*4)+ dc(3)*(y(3+(i+1)*4)+y(3+(i-1)*4)-2*y(3+i*4));%-0.001*y(3+i*4);%ferroin decay?
        dy(4+i*4) = 2*k1*y(1+i*4)*y(2+i*4)+k2*y(2+i*4)+k3*y(1+i*4)^2-k7*y(4+i*4)+ dc(4)*(y(4+(i+1)*4)+y(4+(i-1)*4)-2*y(4+i*4));
