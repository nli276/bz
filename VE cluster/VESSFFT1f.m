...
function [qmx,lmx,wmx,qmxn,lmxn,wmxn]=VESSFFT1f(myseed,mytaskid)
tic;
rng(myseed)
...
%         filename1=['LmuU',num2str(dc(4)),'a', num2str(bz), 'b',num2str(oil), 'umMA',num2str(m*1e3),'mM',num2str(n),'drops','.png'];
        filename2=['NmuU',num2str(dc(4)),'a', num2str(bz), 'b',num2str(oil), 'umMA',num2str(m*1e3),'mM',num2str(n),'drops_',num2str(mytaskid),'.png'];
