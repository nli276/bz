...
for malp=1:nma
    ...
    runtime=3000;%10;%
    timestep=1;%1e-3;%
%     n=6;%100;%# of droplets on a ring, n>=2
%         nc=1;%10;%# of cycles
    ...
    for szlp=1:nsz
        ...
        filename1=['LmuU',num2str(dc(4)),'a', num2str(bz), 'b',num2str(oil), 'umMA',num2str(m*1e3),'mM',num2str(n),'drops','.png'];
        filename2=['NmuU',num2str(dc(4)),'a', num2str(bz), 'b',num2str(oil), 'umMA',num2str(m*1e3),'mM',num2str(n),'drops_',num2str(nc),'.png'];
        ...
        xlabel('t')
        ylabel('d')
        title(['\mu_U=',num2str(dc(4)),', a=', num2str(bz), ',b=',num2str(oil), 'um, MA=',num2str(m*1e3),'mM,',num2str(n),'drops']);
...
%         saveas(h1,filename1,'png')
        ...
        xlabel('wn')
        ylabel('qn')
        title(['qn=', num2str((I3(I4)-2+qs)/(n/2)),', ln=',num2str(n/(I3(I4)-2+qs)),', wn=',num2str(I4-2+ws)]);
        saveas(h2,filename2,'png')
        %       pause
